      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.imageContainer}>
          <View style={styles.image}>
            <Image style={{ resizeMode: 'center' }} source={require("./assets/images/selfie.jpg")}></Image>
          </View>
        </View>
        {/* text container */}
        <View style={styles.informationContainer}>
          ...
          <Text style={styles.text} onPress={() => Linking.openURL("mailto:jjohn172@hgtc.edu")}>jjohn172@hgtc.edu</Text>
