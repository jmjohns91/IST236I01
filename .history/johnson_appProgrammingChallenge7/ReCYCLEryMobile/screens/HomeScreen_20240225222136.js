          ...
          <View style={styles.switchContainer}>
            <View style={styles.switchSubContainer}>
              ...
              <Switch
                ...
                trackColor={{ false: Colors.primaryText, true: Colors.primary }}
              />
            </View>
            <View style={styles.switchSubContainer}>
              ...
              <Switch
                ...
                thumbColor={props.rentalMembership ? Colors.divider : Colors.primaryText}
                trackColor={{ false: Colors.accentColor, true: Colors.primaryText }}
              />
            </View>
          </View>
