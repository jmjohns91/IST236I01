          ...
          <View style={styles.switchContainer}>
            <View style={styles.switchSubContainer}>
              ...
              <Switch
                ...
                thumbColor={props.newsletter ? Colors.primary : Colors.divider}
                trackColor={{ false: Colors.primaryLight, true: Colors.primaryText }}
              />
            </View>
            <View style={styles.switchSubContainer}>
              ...
              <Switch
                ...
                thumbColor={props.rentalMembership ? Colors.primary : Colors.divider}
                trackColor={{ false: Colors.primaryLight, true: Colors.primaryText }}
              />
            </View>
          </View>
