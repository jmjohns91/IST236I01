  ...
  return (
    <View style={[
      ...
      <View style={styles.serviceContainer}>
        ...
        <Text style={styles.subService}>{props.services}</Text>
        <Text style={styles.service}>Newsletter:</Text>
        <Text style={styles.subService}>{props.newsletter}</Text>
        <Text style={styles.service}>Rental Club:</Text>
        <Text style={styles.subService}>{props.rentalMembership}</Text>
      </View>
