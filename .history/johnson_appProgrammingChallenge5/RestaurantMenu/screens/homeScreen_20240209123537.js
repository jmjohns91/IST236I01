  ...
  return (
    <View style={[
      ...
      <View style={styles.infoContainer}>
        ...
        <Text style={styles.info} onPress={() => Linking.openURL("https://maps.app.goo.gl/A1CUoqJCSBDQAtzb7")}>2060 Lower Rosewell Rd Ste. 160, Marietta, GA, 30068</Text>
        <Text style={styles.info} onPress={() => Linking.openURL("https://www.threecolorga.com/")}>Website</Text>
      </View >
    </View >
  )
}
