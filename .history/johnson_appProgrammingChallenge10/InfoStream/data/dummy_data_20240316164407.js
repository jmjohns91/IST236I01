...
export const articles = [
  new Article(
    ...
    "TechCrunch",
    "Mar 16, 2024",
    "Box shifts focus to workflow automation and AI",
    "imageUrl",
    "Box, a content management company, is moving towards integrating AI and workflow automation."
  ),
  new Article(
    2,
    "tech",
    ...
    "TechCrunch",
    "Mar 16, 2024",
    "GitHub's AI challenges",
    "imageUrl",
    "GitHub's chief legal officer Shelley McKinley faces legal challenges around its Copilot program and AI Act."
  ),
  new Article(
    3,
    "Townhouse",
