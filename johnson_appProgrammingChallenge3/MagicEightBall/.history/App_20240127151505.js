...
export default function App() {
  ...
  function setUserQuestion() {
    TextInput.value = userQuestion;
  }
  function setBallResponse() {
    const responses = [
      "It is certain",
      "It is decidedly so",
      "Without a doubt",
    ...
    <>
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          <Pressable android_ripple={{ color: "#b354f3" }} style={({ pressed }) => pressed && styles.pressedButton} onPress={startShakeTheBall}>
        ...
        <Modal visible={modalVisible}
          onRequestClose={() => {
            ...
            <View style={styles.buttonContainer}>
              <Pressable android_ripple={{ color: "#b354f3" }} style={({ pressed }) => pressed && styles.pressedButton} onPress={() => setModalVisible(!modalVisible); TextInput.clear}>
              <View style={styles.button}>
                <Text style={styles.buttonText}>
                  Back
                </Text>
