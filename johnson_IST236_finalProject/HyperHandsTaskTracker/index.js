...
export { View, Text, StyleSheet, ScrollView, Button, Modal, Image, Alert, TouchableOpacity, Pressable, TextInput } from 'react-native';
...
export * as ExpoIcons from '@expo/vector-icons';
export { ImagePicker } from 'react-native-image-picker';
export { IconPicker } from "react-native-icon-picker";
